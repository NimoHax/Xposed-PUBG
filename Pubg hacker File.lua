...
function WHC()
  MENU9 = gg.multiChoice({
    "🍉WallHack for Snap 625+🍇",
    "🍇Wallhack for All Snapdragons🍓",
    "🌰Wallhack for Snap 835+🌰",
    "🍏Wallhack for Snap 400+🍏",
    "🍄Wallhack for Snap 425+🍍",
    "🍑Wallhack for Snap 435+🍅",
    "🍊White Colour [All Device]🌳",
    "🌷Black Colour [All Device]🌲",
    "🍆Body Blue🍋",
    "🍒Body Red🌴",
    "🌹Body Green🌹",
    "🌈Body Gradient🌺",
  ...
  if MENU9 == nil then
    ...
    if MENU9[15] == true then
      BG()
    end
    if MENU9[16] == true then
      C()
    end
  end
  XGCK = 1
...
function B()
  MENU7 = gg.multiChoice({
    ...
    "⭕AimLock [Must Use]",
    "⭕Medium Aimbot",
    "⭕Auto Headshot 99% [Updated]",
    "⭕Increase Damage",
    "⭕No Recoil [Updated]",
    "⭕Less Recoil",
    "⭕Antenna Always (After Land)",
    "⭕Big Helmet (After Land)",
    "⭕Small Crosshair",
    "---[🔙BACK🔙]---"
  }, nil, "---[⏳Lobby Menu⏳]---")
  if MENU7 == nil then
    ...
    if MENU7[9] == true then
      bgh()
    end
    if MENU7[10] == true then
      cross()
    end
    if MENU7[11] == true then
      Main()
    end
  end
  XGCK = 1
...
function auh()
  ...
  gg.clearResults()
  gg.toast("AKTIF")
  gg.alert(" Don't use scope for HeadShoT")
end
function mai()
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
...
function sbps()
  gg.setVisible(false)
  HH = gg.alert("Do you Want to activate Bypass?", "Yes", "No ")
  if HH == 1 then
    bps()
  end
  if HH == 2 then
...
function wh0()
  ...
  gg.editAll("120", gg.TYPE_FLOAT)
  gg.clearResults()
  gg.toast("Wallhack for All Snapactivated")
end
function wh1()
  gg.clearResults()
  gg.setRanges(gg.REGION_BAD)
...
function NR()
  ...
  gg.editAll("186875642", gg.TYPE_DWORD)
  gg.clearResults()
...
function C()
  ...
  if MENU2 == nil then
    ...
    if MENU2[12] == true then
      sh3()
    end
    if MENU2[13] == true then
      sh1()
    end
    if MENU2[14] == true then
      hiden()
    end
    if MENU2[15] == true then
      blacksky()
    end
    if MENU2[16] == true then
      M24()
    end
    if MENU2[17] == true then
      AWM()
    end
    if MENU2[18] == true then
      KAR98()
    end
    if MENU2[19] == true then
      Main()
    end
  end
  XGCK = -1
...
function hed()
  ...
  gg.editAll("500", gg.TYPE_FLOAT)
  gg.clearResults()
  gg.toast("Auto Headshot 90 activated")
end
function ran()
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
  ...
  gg.clearResults()
  gg.toast("Range OF Damage activated")
end
function sof()
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
...
function AWM()
  gg.toast("Sniper AWM Fire rate working")
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
  ...
  gg.clearResults()
  gg.toast("Awm Firing Rate activated")
end
function hiden()
...
function NG2()
  gg.toast("Jeep Mountain Climbing is Working...")
  gg.clearResults()
  ...
  gg.editAll("9999", gg.TYPE_FLOAT)
  gg.clearResults()
  gg.toast("Jeep Mountain Climb Active!")
end
function M24()
  gg.toast("Sniper M24 Firing Rate working...")
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
  ...
  gg.editAll("500000", gg.TYPE_FLOAT)
  gg.clearResults()
  gg.toast("Sniper M24 Firing Rate Activated!")
end
function itw()
  gg.clearResults()
  gg.setRanges(gg.REGION_BAD)
...
function fis()
  ...
  gg.clearResults()
  gg.alert("Visual Lift activated")
end
function atn2()
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.clearResults()
...
function ctn()
  CONTACT = gg.choice({
    "[SGB Team Made it so Its Best]",
    "[➡Telegram: t.me/SGBvip]",
    "[🚫Dont Leak It!]",
    "---[↗BACK➡]---"
  }, nil, "---[🕦CONTACT🕚]---")
  if CONTACTS == 1 then
...
function Exit()
  print("➠Hᴏᴘᴇ Yᴏᴜ Eɴᴊᴏʏᴇᴅ ")
  print("➠ Telegram : https://t.me/SGBxVenom")
  print("➠ Donate   : https://www.paypal.me/biswajit3663")
  print([[
